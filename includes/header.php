...
<head>
    ...
    <link rel="manifest" href="/soma_cashflow/public/manifest.json">
    <meta name="theme-color" content="#0d5c53">
    <link rel="icon" href="/soma_cashflow/public/icons/icon-192.png">
    <link rel="apple-touch-icon" href="/soma_cashflow/public/icons/icon-192.png">
    ...
    <script>
        if ('serviceWorker' in navigator) {
            window.addEventListener('load', () => {
                navigator.serviceWorker.register('/soma_cashflow/public/sw.js')
...
<div class="app-shell">
    <aside class="sidebar" aria-label="Main navigation">
        ...
        <nav>
            ...
            <a class="<?= nav_active((string) $currentPath, 'statements.php') ?>" href="/soma_cashflow/public/statements.php">
                <span class="navicon">&#128202;</span> Statements
            </a>
            <a class="<?= nav_active((string) $currentPath, 'team.php') ?>" href="/soma_cashflow/public/team.php">
                <span class="navicon">&#129309;</span> Team
            </a>
            <a class="<?= nav_active((string) $currentPath, 'investment') ?>" href="/soma_cashflow/public/investments.php">
